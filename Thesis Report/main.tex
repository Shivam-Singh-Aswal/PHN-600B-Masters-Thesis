...
Subsequently, a further reduction from three to two dimensions is performed to derive the 2D effective action. This process also involves an appropriate choice of boundary conditions and the use of the Fefferman-Graham gauge to facilitate asymptotic analysis. The 2D central charge is then extracted using a similar method, analyzing the transformation of the boundary stress-energy tensor under combined conformal and gauge symmetries.
